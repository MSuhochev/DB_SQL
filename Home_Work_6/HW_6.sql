...
DELIMITER $$
DROP PROCEDURE IF EXISTS displacement;
CREATE PROCEDURE  displacement (IN num1 INT) 
	DETERMINISTIC
BEGIN
...
DELIMITER ;
-- CALL displacement(9); -- displacement USER with ID 8 from users to users_old/
